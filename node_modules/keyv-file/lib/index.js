...
class KeyvFile extends events_1.default {
    ...
    _loadDataSync() {
        try {
            ...
            (0, separated_file_store_1.handleIOError)(e, '_loadDataSync:' + this.opts.filename);
            this._data = new Map();
    ...
    releaseFileLock() {
        try {
            ...
            //pass
            (0, separated_file_store_1.handleIOError)(e, "releaseFileLock");
        }
    }
    async get(key) {
        if (this.opts.separatedFile) {
    ...
    getSync(key) {
        ...
        try {
            ...
            (0, separated_file_store_1.handleIOError)(error, key);
        }
        return ret;
    }
    async getMany(keys) {
    ...
    async _getWithExpireAsync(key, data) {
        if (!data) {
            return;
        }
        if (this.isExpired(data)) {
