    ...
    def process(
        ...
        *,
        ...
        logger.info(
            ...
            metadata.get("service_code") or getattr(result.context, "last_service_code", None) or "none",
            metadata.get("topic") or getattr(result.context, "active_topic", None) or "none",
